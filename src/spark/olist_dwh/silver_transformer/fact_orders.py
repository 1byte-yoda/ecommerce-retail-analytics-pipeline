...
def create_fact_orders_df(
    ...
    fact_orders_df = orders_df.join(order_items_df, on=F.col("order_id") == F.col("order_item_order_id"), how="inner") \
        ...
        .join(dim_date_df.alias("shipment_limit"), on=dim_date_df["unix_timestamp"] == F.unix_timestamp("shipment_limit_date")) \
        ...
        .selectExpr(
            ...
            "customer_id",
            "order_status_id",
            "shipment_limit.date_id AS shipment_limit_date_id",

...
def test_dim_date_creation(spark_fixture: SparkSession):
    ...
    expected_dim_date = [
        Row(date_id=1, unix_timestamp=1697104260, timestamp=datetime(2023, 10, 12, 17, 51), year="2023", quarter="4", quarter_name="Q4", month="10", month_name="Oct", year_month="202310", year_week="202341", week_day_name="Thu", week_day_type="weekday", timezone="PST", time_of_day="Afternoon"),  # noqa
        Row(date_id=2, unix_timestamp=1697104261, timestamp=datetime(2023, 10, 12, 17, 51, 1), year="2023", quarter="4", quarter_name="Q4", month="10", month_name="Oct", year_month="202310", year_week="202341", week_day_name="Thu", week_day_type="weekday", timezone="PST", time_of_day="Afternoon"),  # noqa
        Row(date_id=3, unix_timestamp=1697104262, timestamp=datetime(2023, 10, 12, 17, 51, 2), year="2023", quarter="4", quarter_name="Q4", month="10", month_name="Oct", year_month="202310", year_week="202341", week_day_name="Thu", week_day_type="weekday", timezone="PST", time_of_day="Afternoon"),  # noqa
        Row(date_id=4, unix_timestamp=1697104263, timestamp=datetime(2023, 10, 12, 17, 51, 3), year="2023", quarter="4", quarter_name="Q4", month="10", month_name="Oct", year_month="202310", year_week="202341", week_day_name="Thu", week_day_type="weekday", timezone="PST", time_of_day="Afternoon"),  # noqa
        Row(date_id=5, unix_timestamp=1697104264, timestamp=datetime(2023, 10, 12, 17, 51, 4), year="2023", quarter="4", quarter_name="Q4", month="10", month_name="Oct", year_month="202310", year_week="202341", week_day_name="Thu", week_day_type="weekday", timezone="PST", time_of_day="Afternoon"),  # noqa
        Row(date_id=6, unix_timestamp=1697104265, timestamp=datetime(2023, 10, 12, 17, 51, 5), year="2023", quarter="4", quarter_name="Q4", month="10", month_name="Oct", year_month="202310", year_week="202341", week_day_name="Thu", week_day_type="weekday", timezone="PST", time_of_day="Afternoon")  # noqa
    ]

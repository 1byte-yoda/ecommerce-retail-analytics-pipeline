...
def test_dim_sellers_creation(spark_fixture: SparkSession):
    sellers_data = [
        ...
        {"seller_id": "e49c26c3edfa46d227d5121a6b6e4d37,,", "seller_zip_code_prefix": "55325", "seller_city": "brejao", "seller_state": "PE"},
    ...
    expected_dim_customers = [
        Row(
            ...
            seller_state="SP",
            seller_location_latitude=-22.895499290034056,
            seller_location_longitude=-47.061943920624365,
        ),
        Row(
            ...
            seller_state="RJ",
            seller_location_latitude=-22.90786339246341,
            seller_location_longitude=-43.17569296488547,
        ),
        Row(
...
def test_dim_date_creation(spark_fixture: SparkSession):
    ...
    expected_dim_date = [
        Row(
            ...
            date_id=1,
            year=2023,
            unix_timestamp=1697101269,
            quarter=4,
            quarter_name="Q4",
            month=10,
            month_name="Oct",
            year_month=202310,
            year_month_start=datetime(2023, 10, 1, 0, 0),
            year_week=202341,
            week_start=date(2023, 10, 9),
            week_day_name="Thu",
            week_day_type="weekday",
            timezone="PST",
        ...
        Row(
            timestamp=datetime(2023, 10, 12, 17, 51),
            date_id=3,
            year=2023,
            unix_timestamp=1697104260,
            quarter=4,
            quarter_name="Q4",
            month=10,
            month_name="Oct",
        ...
        Row(
            timestamp=datetime(2023, 10, 17, 17, 51),
            date_id=6,
            year=2023,
            unix_timestamp=1697536260,
            quarter=4,
            quarter_name="Q4",
            month=10,
            month_name="Oct",
...
def test_fact_orders_creation(spark_fixture: SparkSession, dim_date_df_fixture: DataFrame):
    ...
    expected_fact_orders = [
        Row(
            ...
            customer_id="ed0271e0b7da060a393796590e7b737a",
            order_status_id=2,
            shipping_limit_date_id=3,
            order_purchase_timestamp_id=1,
            order_approved_at_id=2,
            order_delivered_carrier_date_id=4,
            order_delivered_customer_date_id=5,
            order_estimated_delivery_date_id=5,
            price=49.9,
            freight_value=16.05,
        ),
        Row(
            ...
            customer_id="0aad2e31b3c119c26acb8a47768cd00a",
            order_status_id=3,
            shipping_limit_date_id=11,
            order_purchase_timestamp_id=8,
            order_approved_at_id=9,
            order_delivered_carrier_date_id=10,
            order_delivered_customer_date_id=12,
            order_estimated_delivery_date_id=15,
            price=129.99,
            freight_value=42.16,
        ),
        Row(
        ...
        Row(
            ...
            customer_id="caded193e8e47b8362864762a83db3c5",
            order_status_id=1,
            shipping_limit_date_id=26,
            order_purchase_timestamp_id=23,
            order_approved_at_id=24,
            order_delivered_carrier_date_id=25,
            order_delivered_customer_date_id=25,
            order_estimated_delivery_date_id=27,
            price=14.49,
            freight_value=7.87,
        ),
    ]
...
def test_fact_payments_creation(spark_fixture: SparkSession, dim_date_df_fixture: DataFrame):
    ...
    expected_fact_payments = [
        ...
        Row(
            ...
            customer_id="f444bb4bffe058f24c3b5b5a0c0f46b6",
            order_status_id=3,
            order_purchase_timestamp_id=16,
            order_approved_at_id=17,
            order_delivered_carrier_date_id=18,
            order_delivered_customer_date_id=19,
            order_estimated_delivery_date_id=22,
            payment_sequential=1,
            payment_type="credit_card",
            payment_installments=1,
            payment_value=2.29,
...
def test_fact_reviews_creation(spark_fixture: SparkSession, dim_date_df_fixture: DataFrame):
    ...
    expected_fact_reviews = [
        Row(
            ...
            customer_id="ed0271e0b7da060a393796590e7b737a",
            order_status_id=2,
            review_creation_date_id=6,
            review_answer_timestamp_id=7,
            review_score=2,
            review_comment_title="",
            review_comment_message="fiquei triste por n ter me atendido.",
        ),
        Row(
            ...
            customer_id="f444bb4bffe058f24c3b5b5a0c0f46b6",
            order_status_id=3,
            review_creation_date_id=20,
            review_answer_timestamp_id=21,
            review_score=4,
            review_comment_title="",
            review_comment_message="",
        ),
        Row(
            ...
            customer_id="0aad2e31b3c119c26acb8a47768cd00a",
            order_status_id=3,
            review_creation_date_id=13,
            review_answer_timestamp_id=14,
            review_score=1,
            review_comment_title="",
            review_comment_message="Não recebi meus produtos ",
        ),
